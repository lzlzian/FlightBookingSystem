...
public class Edit_FlightActivity extends AppCompatActivity {
    ...
    public void submitInfo(View view) {
        ...
        if((isValidDateTime(arrivalDateTime)||arrivalDateTime.isEmpty())
            ...
            // puts a message that confirms flight info changes
            new AlertDialog.Builder(Edit_FlightActivity.this)
                    .setTitle( "EDIT FLIGHT" )
                    .setMessage( "you successful change flight information to: "
                            +"\n"+flight.toString())
                    .setPositiveButton( "YES", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            Log.d( "AlertDialog", "Positive" );
                            MainActivity.fm.getFlights().remove(flightNumber);
     ...
     * The date and time must be in the correct format and must
     * not have passed already
     ...
     * Prices must match a correct format
